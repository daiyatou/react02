        ...
        return (
            <View style={styles.btm_choose}>
             <View style={[styles.btm_bg_gray, styles.btm_choose_btn ]}>
         			  <Image source={require('../images/common/icon-store.png')} style={styles.btm_choose_icon}/>
         		 </View>
             <View style={[styles.btm_bg_gray, styles.btm_choose_btn ]}>
               <Image source={require('../images/common/icon-cart.png')} style={styles.btm_choose_icon}/>
             </View>
